## Pink Raycast
particle minecraft:cherry_leaves ^ ^ ^ 0 0 0 0 1
...
execute unless score @s gbg.raycast_distance >= gbg.range gbg.temp positioned ^ ^ ^0.2 rotated ~ ~0.2 run function gbg:gun/raycast/projectile/pink_ray
