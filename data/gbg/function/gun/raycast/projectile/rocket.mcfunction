...
# When Hit
#block
execute unless block ^ ^ ^ #gbg:slowcast_generic run function gbg:gun/raycast/hit_block
execute unless block ^ ^ ^ #gbg:slowcast_generic run return fail
#entity
...
execute unless score @s gbg.raycast_distance >= gbg.range gbg.temp positioned ^ ^ ^0.2 rotated ~ ~ run function gbg:gun/raycast/projectile/rocket
