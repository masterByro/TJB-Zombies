...
execute if score @s gbg.temp matches 0 run particle dust{color:[0.918,0.941,0.263],scale:1} ^ ^ ^ 0 0 0 0 1 normal
...
execute unless score @s gbg.raycast_distance >= gbg.range gbg.temp positioned ^ ^ ^0.2 rotated ~ ~ run function gbg:gun/raycast/projectile/yellow_laser
