...
execute if score @s gbg.temp matches 0 run particle dust{color:[0.612,1.000,0.961],scale:1} ^ ^ ^ 0 0 0 0 1 normal
...
execute unless score @s gbg.raycast_distance >= gbg.range gbg.temp positioned ^ ^ ^0.2 rotated ~ ~ run function gbg:gun/raycast/projectile/cyan_laser
