## Rocket Raycast
particle minecraft:cherry_leaves ^ ^ ^ 0.04 0.04 0.04 0.04 1 force
...
tp ~ ~ ~
rotate @s ~ ~
execute if score @s gbg.temp matches 1.. unless score @s gbg.slowcast.range >= @s gbg.slowcast.max_range positioned ^ ^ ^0.2 rotated ~ ~0.5 run function gbg:gun/slowcast/projectile/pink_ray
