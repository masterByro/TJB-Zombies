## Rocket Raycast
particle minecraft:crit ^ ^ ^ 0.02 0.02 0.02 0.04 1 force
particle minecraft:crit ^ ^ ^ 0.1 0.1 0.1 0.01 1 normal
...
tp ~ ~ ~
rotate @s ~ ~
execute if score @s gbg.temp matches 1.. unless score @s gbg.slowcast.range >= @s gbg.slowcast.max_range positioned ^ ^ ^0.2 rotated ~ ~0.25 run function gbg:gun/slowcast/projectile/grenade
