execute if data entity @s {Inventory:[{Slot:3b,components:{"minecraft:custom_name":{text:"Bowie Knife"}}}]} run tag @s add owned
...
execute unless entity @s[tag=owned] run scoreboard players operation @s Money -= BowieKnifeCost Prices
